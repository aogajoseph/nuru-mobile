...
const upcomingEvents = [
  {
    ...
    date: 'Aug 12–16, 2024',
    description:
      'A week of adventure, worship, and friendship in the wild! Register now for an unforgettable experience.',
  },
  {
    title: 'Charity Fundraiser Dinner',
    subtitle: 'Nairobi Serena Hotel',
    image:
      'https://nairobichapel.net/wp-content/uploads/2015/07/XP-DICE-Dance-group-1.png',
    date: 'Sep 7, 2024',
    description:
      'Join us for an elegant evening to support our community outreach programs. Tickets available online.',
  },
];
...
const pastEvents = [
  {
    ...
    date: 'May 18, 2024',
    description:
      'Games, food, and fun for all ages! Thank you for making it a memorable day.',
  },
  {
    title: 'Men’s Football Tournament',
    subtitle: 'Nairobi Sports Grounds',
    image:
      'https://nairobichapel.net/wp-content/uploads/2015/07/Chapel-2006-1024x683.jpg',
    date: 'Apr 13, 2024',
    description:
      'Congratulations to all teams for great sportsmanship and fellowship!',
  },
  {
    title: 'Ladies’ Hiking Retreat',
    subtitle: 'Ngong Hills',
    image:
      'https://nairobichapel.net/wp-content/uploads/2015/07/Chapel-2015-1024x683.jpg',
    date: 'Mar 2, 2024',
  ...
  },
  {
    ...
    image:
      'https://nairobichapel.net/wp-content/uploads/2015/07/egroup2.png',
    date: 'Feb 10, 2024',
    description:
      'A fun night of movies, snacks, and new friendships!',
  },
];
